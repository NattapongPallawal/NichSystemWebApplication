...
@Component({
  selector: 'app-dialog-food-day',
  templateUrl: './dialog-food-day.component.html',
  styleUrls: ['./dialog-food-day.component.css']
})

export class DialogFoodDayComponent implements OnInit {
